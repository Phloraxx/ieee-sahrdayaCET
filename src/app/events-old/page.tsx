...
import { ArrowRight, QrCode, Users, Layout, Terminal, Share2, CheckCircle, Zap, BarChart3, TrendingUp } from 'lucide-react';
            ...
            <AnimatedSection className="py-20 sm:py-32 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        {/* Live Event Analytics Card - events-1 */}
                        <motion.div 
                            variants={scaleIn}
                        ...
                        {/* Quick Actions Card - events-1 companion */}
                        <motion.div 
                            variants={scaleIn}
                            whileHover={{ y: -5 }}
                            transition={{ duration: 0.3 }}
                        ...
                        >
                            <div>
                                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#ebf1ff] rounded-full mb-6">
                                    <span className="w-2 h-2 rounded-full bg-[#006097] animate-pulse" />
                                    <span className="text-xs font-semibold text-[#006097] uppercase tracking-wide">New Feature</span>
                                </div>
                                <h3 className="font-sans font-bold text-xl sm:text-2xl mb-4 text-[#152f50]">Smart Event Scheduler</h3>
                                <p className="text-[#455d7f] leading-relaxed mb-6">
                                ...
                                <ul className="space-y-3">
                                    {['Conflict-free scheduling', 'Room optimization', 'Attendee preferences'].map((feature, i) => (
                                        <li key={i} className="flex items-center gap-3 text-[#455d7f]">
                            ...
                            <button className="mt-8 w-full py-4 bg-[#006097] text-white rounded-full font-sans font-bold hover:bg-[#004d73] transition-colors flex items-center justify-center gap-2 group">
                                Try Smart Scheduler
                                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </button>
                        </motion.div>
